...
using static Reports.Application.Contracts.MessageSources.CreateEmailMessageSource;
...
public class CreateEmailMessageSourceHandler : IRequestHandler<Command, Response>
{
    ...
    public CreateEmailMessageSourceHandler(IReportsDatabaseContext context)
    {
    ...
    {
        var newMessageSource = new EmailMessageSource(request.Email);
